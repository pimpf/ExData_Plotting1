...
# 
# This is the fourth out of four scripts which are part of Course Project 1 of
...
# Partition into two rows and two columns
par(mfrow = c(2, 2));

# plot 1 - the same as per script plot2.R
plot(data$DateTime,
     data$Global_active_power,type = "l",
     xlab = "",
     ylab = "Global Active Power (kilowatts)");

# plot 2 - distribution of voltage in datetime
plot(data$DateTime,
     data$Voltage,
     type = "l",
     xlab = "datetime",
